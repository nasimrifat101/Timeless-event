  ...
  return (
    <div className="mt-32">
      ...
      <div className="bg-[#F4F1EA]">
        <div className="max-w-6xl mx-auto grid px-3 lg;px-0  lg:grid-cols-2 gap-5">
          <div className="text-center">
            <h1 className="text-3xl md:text-6xl  pb-5">Planning</h1>
            <p>
          ...
          <div className="text-center">
            <h1 className="text-3xl md:text-6xl pb-5">Design</h1>
            <p>
          ...
          <div className="text-center">
            <h1 className="text-3xl md:text-6xl  pb-5">Production</h1>
            <p>
          ...
          <div className="text-center">
            <h1 className="text-3xl md:text-6xl  pb-5">Cultivation</h1>
            <p>
        ...
        <Link to='/services'>
        <button className="btn bg-yellow-400 md:w-96 text-black font-bebas text-xl">Learn More About our services</button>
        </Link>
          </div> 
      </div>
    </div>
